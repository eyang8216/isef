...
\begin{equation}
    \vartheta_0\approx \SI{130.7}{\degree}.
\end{equation}
The semi-vertical half-angle measured inside the liquid cone is therefore
\begin{equation}
    \alpha_T=\SI{180}{\degree}-\vartheta_0\approx \SI{49.3}{\degree}.
\end{equation}
...
\end{equation}
The first term is the azimuthal curvature generated by rotating the curve about the axis, and the second term is the meridional curvature of the curve in the $(r,z)$ plane. This expression is used directly in the residual computation.
