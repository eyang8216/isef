...
\paragraph{Computational Performance.} Solution time scales approximately as $\mathcal{O}(N^{2.3})$ where $N$ is the total number of grid points. For the present implementation, a production-quality $121\times177$ grid (21,417 points) solves in approximately 13 seconds on the recorded 2020 MacBook Pro test system. This is a project-specific benchmark, not a general claim about all multiphysics software or hardware.
